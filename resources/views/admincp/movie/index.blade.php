            ...
            <table class="table" id="tablephim">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      {!! Form::select('topviews', ['0'=>'Ngày','1'=>'Tuần','2'=>'Tháng'], isset($movie) ? $movie->topviews : '', ['class'=>'select-topviews','id'=>$cate->id]) !!}
                  </td>
                  <td>
                    @csrf
                      {!! Form::selectYear('season',1,20,isset($cate->year) ? $cate->year : '',['class'=>'select-season','id'=>$cate->id])!!}
                  </td>
