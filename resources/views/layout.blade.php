...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="gCzh2PDN"></script>
      {{-- <script type="text/javascript">
         $(".#watch_trailler").click(function(e) {
            e.preventDefault();
                           ...
                           $.getJSON('json_file/movie.json',function(data){
                               $.each(data, function(key,value){
                                   if(value.title.search(expression) != -1){
                                       $('#result').append('<li style="cursor:pointer; display: flex; max-height: 100px;" class="list-group-item link-class"><img src="uploads/movie/'+value.image+'" width="50" class="" /><div style="flex-direction: column; margin-left: 2px;"><h4 width="50%">'+value.title+'</h4><span style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 5; line-height: 1.6rem;" class="text-muted"></span></div></li>'); 
                                   }
                               });
                           })
                       }else{
